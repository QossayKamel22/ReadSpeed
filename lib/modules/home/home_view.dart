          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Hi, Qossay 👋', style: AppTextStyles.h1),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Obx(() => Row(
                                ...
                                children: [
                                  Text('${c.dailyProgressMinutes.value}',
                          ...
                          Obx(() => AppProgressBar(value: c.dailyProgress)),
                        ],
                      ),
                    ),
                    const SizedBox(width: 20),
                    Obx(() => CircularProgress(
                        value: c.dailyProgress, size: 76)),
                  ],
                ),
              ),
              ...
              ContinueReadingCard(
                ...
                onTap: () => BookDetailsModal.show(context, MockData.continueReading),
              ),
              const SizedBox(height: 24),
              ...
              LayoutBuilder(builder: (context, constraints) {
                final cross = constraints.maxWidth > 700 ? 3 : 3;
                return GridView.count(
                  ...
                  children: const [
                    MetricCard(
                        label: 'WPM', value: '320', icon: Icons.speed_rounded),
                    MetricCard(
                        label: 'Accuracy',
                        value: '92%',
